...
class StringsEN extends Strings {
    ...
    StringsEN() {
        super.APP_NAME = "InstaFram";

        super.FRAME_MAIN = "InstaFram";
        super.FRAME_ABOUT = "About";
        super.FRAME_SETTINGS = "Settings";
        super.FRAME_LOGIN = "Login";
        super.FRAME_INSTALL = "Install";
        ...
        super.ERROR_CANNOT_READ = "Cannot read from specified source";
        ...
        super.ERROR_CANNOT_BUILD = "Configuration cannot be built";
        super.ERROR_PRODUCT_NOT_SELECTED = "Product is not selected";
        super.ERROR_NO_PARAMETERS = "Product has no parameters";
        super.ERROR_RESTRICTED_ACCESS = "Restricted access";
        super.ERROR_ACTION_FOR_PARAMETERS = "Action cannot be applied to non-parameters";
        ...
        super.INFO_APP_FILES = "InstaFram files";
        super.INFO_NODE_NAME = "Name";
        super.INFO_NODE_CONTENT = "Content";
        super.INFO_NODE_PARENT_NAME = "Parent name";
        super.INFO_NODE_CHILD_COUNT = "Child count";
        super.INFO_NODE_LEAF_COUNT = "Leaf count";
        ...
        super.QUESTION_PARAMETER_TYPE = "What type of parameter would you like to add?";
        ...
        super.INPUT_CONTENT = "Content";
        super.INPUT_VALUE = "Value";
        super.INPUT_OPTIONS = "Options";

        super.STATUS_SAVE = "Saved";
        super.STATUS_LOAD = "Loaded";
        ...
        super.STATUS_RUN = "Running";

        super.PARAMETER_AUTHOR = "Author";
        super.PARAMETER_SHORTCUT = "Desktop shortcut";
        super.PARAMETER_TERMS = "Terms and conditions";
        super.PARAMETER_AUTORUN = "Autorun";
        super.PARAMETER_LOGO = "Logo";
        super.PARAMETER_LOOKFEEL = "Look and feel";
        super.PARAMETER_NAME = "Name";
        super.PARAMETER_SOURCE = "Source";
        super.PARAMETER_DESTINATION = "Destination";

        super.ABOUT_VERSION = "Version: ";
        super.ABOUT_AUTHOR = "Author: ";
        super.ABOUT_DESCRIPTION = "Badass app made as a project in Software Design course at Faculty of Computing in Belgrade.";
    }
}